    ...
    <div class="registerCon">
        <ul>
            <li class="accAndPwd">
                ...
                <dl>
                    <s class="password"></s>
                    <input class="pwd2" maxlength="11" type="text" placeholder="请确认密码" value="" />
                    <input class="pwd" maxlength="11" type="password" placeholder="请确认密码" value="" style="display: none" />
                    <span class="mr clear">x</span>
                    <s class="eyeclose"></s>
                </dl>
                <dl>
                    <input id="txtPassword" type="password" placeholder="验证码"
                           value="" maxlength="20" />
...
<script>
        ...
        $(function(){
            ...
            $('#btnNext').click(function(){
                ...
                $.ajax({
                    url:'{{url('register')}}',
                    data:'tel='+tel+'&pwd='+pwd+'&pwd2='+pwd2+'&vcode='+vcode,
                    dataType:'json',
                    type:'post',
